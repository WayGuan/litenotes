"use strict";var He=Object.create;var J=Object.defineProperty;var Ne=Object.getOwnPropertyDescriptor;var Je=Object.getOwnPropertyNames;var Xe=Object.getPrototypeOf,Ue=Object.prototype.hasOwnProperty;var Me=(h,e)=>{for(var t in e)J(h,t,{get:e[t],enumerable:!0})},oe=(h,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Je(e))!Ue.call(h,r)&&r!==t&&J(h,r,{get:()=>e[r],enumerable:!(n=Ne(e,r))||n.enumerable});return h};var f=(h,e,t)=>(t=h!=null?He(Xe(h)):{},oe(e||!h||!h.__esModule?J(t,"default",{value:h,enumerable:!0}):t,h)),Ve=h=>oe(J({},"__esModule",{value:!0}),h);var it={};Me(it,{BladeFormatter:()=>N,Formatter:()=>A});module.exports=Ve(it);var je=f(require("ignore")),B=f(require("path")),j=f(require("fs")),g=f(require("process")),b=f(require("chalk")),We=f(require("glob")),se=f(require("util")),v=f(require("lodash")),ae=f(require("find-config"));var R=f(require("js-beautify")),i=f(require("lodash")),nt=f(require("vscode-textmate")),w=f(require("detect-indent")),Re=f(require("aigle")),Ee=f(require("xregexp")),q=require("@shufo/tailwindcss-class-sorter"),ie=require("html-attribute-sorter");var xe=require("fs"),Ce=f(require("lodash")),re=f(require("vscode-oniguruma")),Be=f(require("path"));var x=f(require("lodash")),ue=f(require("fs")),me=f(require("os")),V=f(require("chalk")),K=f(require("prettier/standalone")),Q=f(require("@prettier/plugin-php/standalone")),Ke=f(require("detect-indent"));var W=f(require("lodash")),k="@",$=["@alert","@pushonce","@push","@slot","@switch","@unless","@verbatim","@prependonce","@prepend","@once","@error","@empty","@guest","@isset","@permission","@permissions","@canany","@cannot","@can","@role","@hasrole","@hasanyrole","@hasallroles","@unlessrole","@hasexactroles","@if","@production","@env","@while","@auth","@forelse","@for","@foreach","@php","@component","@section","@customdirective"],le=W.default.map($,h=>h.substring(1)),E=["@endalert","@endpushonce","@endpush","@endslot","@endswitch","@endunless","@endverbatim","@show","@stop","@endprependonce","@endprepend","@endonce","@enderror","@append","@overwrite","@endempty","@endguest","@endisset","@endpermission","@endpermissions","@endcanany","@endcannot","@endcan","@endrole","@endhasrole","@endhasanyrole","@endhasallroles","@endunlessrole","@endhasexactroles","@endif","@endproduction","@endenv","@endwhile","@endauth","@endforelse","@endforeach","@endfor","@endphp","@endcomponent","@endsection","@endcustomdirective"],D=["@elseenv","@elseif","@elsecanany","@elsecannot","@elsecan","@else","@elsecustomdirective"],Y={"@section":2,"@push":2,"@prepend":2,"@slot":2},ce=["@forelse","@if"],ee=["@empty"],he=["@default"],T=["@forelse","@if","@for","@foreach","@while","@sectionmissing","@case"],X=["@endforelse","@endif","@endforeach","@endfor","@endwhile","@break"],te=["@button","@class","@include","@disabled","@checked","@json"],O=["@set","@json","@selected","@checked","@disabled","@php","@include","@includeif","@includewhen","@includeunless","@includefirst","@button","@class","@props","@aware"],pe=["@if","@while","@case","@isset","@empty","@elseif","@component","@hassection","@unless"],U=["@hassection"],M=["@charset","@color-profile","@counter-style","@font-face","@font-feature-values","@import","@keyframes","@media","@namespace","@page","@property","@supports"];function de(h,e){return W.default.filter(h.tokens,t=>{let n=e.substring(t.startIndex,t.endIndex).trim();return W.default.includes($,n)||W.default.includes(E,n)}).length>=2}var y="\\(((?:[^)(]+|\\((?:[^)(]+|\\((?:[^)(]+|\\((?:[^)(]+|\\([^)(]*\\))*\\))*\\))*\\))*)\\)?";var _=h=>{let e={get(){return null}};return x.default.isUndefined(h)||x.default.isNull(h)?e:h};async function G(h){return new Promise((e,t)=>{ue.default.readFile(h,(n,r)=>n?t(n):e(r))})}function z(h){return h?h.split(/\r\n|\n|\r/):""}var F=1e3,ge={noPhpSyntaxCheck:!1,printWidth:F,trailingCommaPHP:!0,phpVersion:"8.1",singleQuote:!0};function L(h,e={}){let t={...ge,...e};try{return K.default.format(h.replace(/\n$/,""),{parser:"php",printWidth:1e3,singleQuote:t.singleQuote,phpVersion:t.phpVersion,trailingCommaPHP:t.trailingCommaPHP,plugins:[Q.default]})}catch(n){if(t.noPhpSyntaxCheck===!1)throw n;return h}}function C(h,e={}){let t={...ge,...e};try{return K.default.format(`<?php echo ${h} ?>`,{parser:"php",printWidth:t.printWidth,singleQuote:t.singleQuote,phpVersion:t.phpVersion,trailingCommaPHP:t.trailingCommaPHP,plugins:[Q.default]}).replace(/<\?php echo (.*)?\?>/gs,(n,r)=>r.trim().replace(/;\s*$/,""))}catch(n){if(t.noPhpSyntaxCheck===!1)throw n;return h}}function fe(h){let e=`<?php tmp_func${h}; ?>`,{ast:t}=K.default.__debug.parse(e,{parser:"php",phpVersion:"8.0",plugins:[Q.default]});try{return t.children[0].expression.arguments.length||0}catch{return 0}}function ye(h){return Promise.all(x.default.map(h,async e=>{process.stdout.write(`path: ${V.default.bold(e.path)}:${e.line}
`),process.stdout.write(V.default.red(`--${e.original}
`)),process.stdout.write(V.default.green(`++${e.formatted}
`))}))}function _e(h,e,t){let n=x.default.map(e,(r,s)=>x.default.isEmpty(r)||r===t[s]?null:{path:h,line:s+1,original:r,formatted:t[s]});return x.default.without(n,null)}async function Qe(h){let e=x.default.without($,"@switch","@forelse","@php").join("|"),t=new RegExp(`(?!\\/\\*.*?\\*\\/)(${e})(\\s*?)${y}`,"gmi");return new Promise(n=>n(h)).then(n=>x.default.replace(n,t,(r,s,a,l)=>L(`<?php ${s.substr("1")}${a}(${l}) ?>`).replace(/<\?php\s(.*?)(\s*?)\((.*?)\);*\s\?>\n/gs,(o,c,d,p)=>`@${c.trim()}${d}(${p.trim()})`).replace(/([\n\s]*)->([\n\s]*)/gs,"->").replace(/,\)$/,")").replace(/(?:\n\s*)* as(?= (?:&{0,1}\$[\w]+|list|\[\$[\w]+))/g," as"))).then(n=>L(n))}async function we(h){return Qe(h)}function ve(h){let e=x.default.without(T,"@case"),t=x.default.without(X,"@break");return new Promise(n=>n(h)).then(n=>{let r=new RegExp(`(${e.join("|")})([\\s]*?)${y}`,"gis");return x.default.replace(n,r,(s,a,l,o)=>`<beautifyTag start="${a}${l}" exp="^^^${x.default.escape(o)}^^^">`)}).then(n=>{let r=new RegExp(`(?!end=".*)(${t.join("|")})(?!.*")`,"gi");return x.default.replace(n,r,(s,a)=>`</beautifyTag end="${a}">`)})}function Pe(h){return new Promise(e=>e(h)).then(e=>x.default.replace(e,/<beautifyTag.*?start="(.*?)".*?exp=".*?\^\^\^(.*?)\^\^\^.*?"\s*>/gs,(t,n,r)=>`${n}(${x.default.unescape(r)})`)).then(e=>x.default.replace(e,/<\/beautifyTag.*?end="(.*?)"\s*>/gs,(t,n)=>`${n}`))}var Ge=["/\\*\\* phptag_start \\*\\*/","/\\*\\* end_phptag \\*\\*/","/\\*escaped\\*/","__BLADE__;","/\\* blade_comment_start \\*/","/\\* blade_comment_end \\*/","/\\*\\*\\*script_placeholder\\*\\*\\*/","beautifyTag","@customdirective","@elsecustomdirective","@endcustomdirective"];function $e(h){if(new RegExp(Ge.join("|")).test(h))throw new Error(["Can't format blade: something goes wrong.","Please check if template is too complicated or not. Or simplify template might solves issue."].join(`
`));return h}function ne(h){return h.replace(/\$/g,"$$$$")}function be(h){switch(h){case"LF":return`
`;case"CRLF":return`\r
`;default:return me.default.EOL}}var Z=class{constructor(e,t){return(async()=>{var n;return this.vsctm=(n=e.default)!=null?n:e,this.oniguruma=t||re.default||re,await this.loadWasm(),this})()}async loadWasm(){var t;let e=await xe.promises.readFile(require.resolve("vscode-oniguruma/release/onig.wasm"));if(await((t=this.oniguruma)==null?void 0:t.loadWASM(e.buffer)),!this.initCalled){try{this.oniguruma.loadWASM(e.buffer)}catch{this.initCalled=!0}this.initCalled=!0}}createRegistry(){return this.registry=new this.vsctm.Registry({loadGrammar:e=>e==="text.html.php.blade"?G(Be.default.resolve(__dirname,"../syntaxes/blade.tmLanguage.json")).then(t=>this.vsctm.parseRawGrammar(t.toString(),"./blade.tmLanguage.json")):null,onigLib:Promise.resolve({createOnigScanner:e=>new this.oniguruma.OnigScanner(e),createOnigString:e=>new this.oniguruma.OnigString(e)})}),this.registry}tokenizeLines(e,t){return Ce.default.map(e,n=>{var r;return t.tokenizeLine(n,(r=this.vsctm)==null?void 0:r.INITIAL)})}};function qe(h){return h.split(`
`)}function Ye(h){return h.trim().startsWith("*")}function et(h){return h.length>1}function tt(h){return` ${h}`}function Ie(h){let e=qe(h);if(!et(e))return h;let t=!1;return e.map((r,s)=>{if(s===0||t)return r;if(!Ye(r))return t=!0,r;let a=r.trim();return tt(a)}).join(`
`)}var A=class{constructor(e){this.options={noPhpSyntaxCheck:!1,...e},this.vsctm=_(this.options).vsctm||nt,this.oniguruma=_(this.options).oniguruma,this.indentCharacter=_(this.options).useTabs?"	":" ",this.indentSize=_(this.options).indentSize||4,this.wrapLineLength=_(this.options).wrapLineLength||120,this.wrapAttributes=_(this.options).wrapAttributes||"auto",this.currentIndentLevel=0,this.shouldBeIndent=!1,this.isInsideCommentBlock=!1,this.stack=[],this.ignoredLines=[],this.curlyBracesWithJSs=[],this.rawBlocks=[],this.rawPhpTags=[],this.inlineDirectives=[],this.conditions=[],this.inlinePhpDirectives=[],this.rawPropsBlocks=[],this.bladeDirectives=[],this.bladeDirectivesInStyle=[],this.bladeComments=[],this.phpComments=[],this.bladeBraces=[],this.rawBladeBraces=[],this.nonnativeScripts=[],this.scripts=[],this.htmlAttributes=[],this.xData=[],this.xInit=[],this.htmlTags=[],this.templatingStrings=[],this.stringLiteralInPhp=[],this.shorthandBindings=[],this.componentAttributes=[],this.customDirectives=[],this.directivesInScript=[],this.unbalancedDirectives=[],this.escapedBladeDirectives=[],this.result=[],this.diffs=[],this.defaultPhpFormatOption={noPhpSyntaxCheck:this.options.noPhpSyntaxCheck,printWidth:this.wrapLineLength},this.endOfLine=be(_(this.options).endOfLine)}formatContent(e){return new Promise(t=>t(e)).then(t=>this.preserveIgnoredLines(t)).then(t=>this.preserveNonnativeScripts(t)).then(t=>this.preserveCurlyBraceForJS(t)).then(t=>this.preserveRawPhpTags(t)).then(t=>this.preserveEscapedBladeDirective(t)).then(t=>we(t)).then(t=>this.preserveBladeComment(t)).then(t=>this.preserveBladeBrace(t)).then(t=>this.preserveRawBladeBrace(t)).then(t=>this.preserveConditions(t)).then(t=>this.preserveInlineDirective(t)).then(t=>this.preserveInlinePhpDirective(t)).then(t=>this.preserveBladeDirectivesInScripts(t)).then(t=>this.preserveBladeDirectivesInStyles(t)).then(t=>this.preserveCustomDirective(t)).then(t=>this.preserveUnbalancedDirective(t)).then(t=>this.breakLineBeforeAndAfterDirective(t)).then(async t=>(this.bladeDirectives=await this.formatPreservedBladeDirectives(this.bladeDirectives),t)).then(t=>this.preserveScripts(t)).then(t=>this.sortTailwindcssClasses(t)).then(t=>this.formatXInit(t)).then(t=>this.formatXData(t)).then(t=>this.preserveComponentAttribute(t)).then(t=>this.preserveShorthandBinding(t)).then(t=>this.sortHtmlAttributes(t)).then(t=>this.preservePhpBlock(t)).then(t=>this.preserveHtmlAttributes(t)).then(t=>this.preserveHtmlTags(t)).then(t=>this.formatAsHtml(t)).then(t=>this.formatAsBlade(t)).then(t=>this.restoreHtmlTags(t)).then(t=>this.restoreHtmlAttributes(t)).then(t=>this.restorePhpBlock(t)).then(t=>this.restoreShorthandBinding(t)).then(t=>this.restoreComponentAttribute(t)).then(t=>this.restoreXData(t)).then(t=>this.restoreXInit(t)).then(t=>this.restoreScripts(t)).then(t=>this.restoreUnbalancedDirective(t)).then(t=>this.restoreCustomDirective(t)).then(t=>this.restoreBladeDirectivesInStyles(t)).then(t=>this.restoreBladeDirectivesInScripts(t)).then(t=>this.restoreInlinePhpDirective(t)).then(t=>this.restoreInlineDirective(t)).then(t=>this.restoreConditions(t)).then(t=>this.restoreRawBladeBrace(t)).then(t=>this.restoreBladeBrace(t)).then(t=>this.restoreBladeComment(t)).then(t=>this.restoreEscapedBladeDirective(t)).then(t=>this.restoreRawPhpTags(t)).then(t=>this.restoreCurlyBraceForJS(t)).then(t=>this.restoreNonnativeScripts(t)).then(t=>this.restoreIgnoredLines(t)).then(t=>$e(t))}formatAsHtml(e){let t={indent_size:_(this.options).indentSize||4,wrap_line_length:_(this.options).wrapLineLength||120,wrap_attributes:_(this.options).wrapAttributes||"auto",end_with_newline:_(this.options).endWithNewline||!0,max_preserve_newlines:_(this.options).noMultipleEmptyLines?1:void 0,css:{end_with_newline:!1},eol:this.endOfLine},n=new Promise(r=>r(e)).then(r=>ve(r)).then(r=>R.default.html_beautify(r,t)).then(r=>Pe(r));return Promise.resolve(n)}async sortTailwindcssClasses(e){return this.options.sortTailwindcssClasses?i.default.replace(e,/(?<=\s+(?!:)class\s*=\s*([\"\']))(.*?)(?=\1)/gis,(t,n,r)=>{if(i.default.isEmpty(r))return r;if(this.options.tailwindcssConfigPath){let s={tailwindConfigPath:this.options.tailwindcssConfigPath};return(0,q.sortClasses)(r,s)}if(this.options.tailwindcssConfig){let s={tailwindConfig:this.options.tailwindcssConfig};return(0,q.sortClasses)(r,s)}return(0,q.sortClasses)(r)}):e}async preserveIgnoredLines(e){return i.default.chain(e).replace(/(^(?<!.+)^{{--\s*blade-formatter-disable\s*--}}.*?)([\r\n]*)$(?![\r\n])/gis,(t,n,r)=>this.storeIgnoredLines(`${n}${r.replace(/^\n/,"")}`)).replace(/(?:({{--\s*?blade-formatter-disable\s*?--}}|<!--\s*?prettier-ignore-start\s*?-->|{{--\s*?prettier-ignore-start\s*?--}})).*?(?:({{--\s*?blade-formatter-enable\s*?--}}|<!--\s*?prettier-ignore-end\s*?-->|{{--\s*?prettier-ignore-end\s*?--}}))/gis,t=>this.storeIgnoredLines(t)).replace(/(?:{{--\s*?blade-formatter-disable-next-line\s*?--}}|{{--\s*?prettier-ignore\s*?--}}|<!--\s*?prettier-ignore\s*?-->)[\r\n]+[^\r\n]+/gis,t=>this.storeIgnoredLines(t)).value()}async preserveCurlyBraceForJS(e){return i.default.replace(e,/@{{(.*?)}}/gs,(t,n)=>this.storeCurlyBraceForJS(n))}async preservePhpBlock(e){return this.preserveRawPhpBlock(e)}async preservePropsBlock(e){return i.default.replace(e,/@props\(((?:[^\\(\\)]|\([^\\(\\)]*\))*)\)/gs,(t,n)=>this.storeRawPropsBlock(n))}async preserveRawPhpBlock(e){return i.default.replace(e,/(?<!@)@php(.*?)@endphp/gs,(t,n)=>this.storeRawBlock(n))}async preserveHtmlTags(e){let t=["textarea","pre"];return i.default.replace(e,new RegExp(`<(${t.join("|")})\\s{0,1}.*?>.*?<\\/(${t.join("|")})>`,"gis"),n=>this.storeHtmlTag(n))}preserveCustomDirective(e){let t=[...i.default.without($,"@unless"),...E,...D,"@unless\\(.*?\\)"].join("|"),n=i.default.chain([...i.default.without($,"@unless","@for"),...E,...D,...O,...i.default.without(T,"@for"),"@unless[a-z]*\\(.*?\\)","@for\\(.*?\\)",...U,...M]).uniq().join("|").value(),r=new RegExp(`(?!(${n}))(@([a-zA-Z1-9_\\-]+))(?!.*?@end\\3)${y}.*?(?<!@end\\5)`,"gis"),s=new RegExp(`(?!(${t}))(@(unless)*([a-zA-Z1-9_\\-]+))(?!.*?\\2)(\\s|\\(.*?\\))+(.*?)(@end\\4)`,"gis"),a;return a=i.default.replace(e,r,l=>this.storeInlineCustomDirective(l)),a=i.default.replace(a,s,(l,o,c,d,p,u,m,S)=>{if($.includes(c))return l;let P=l;return P=i.default.replace(P,new RegExp(`${c}(${y})*`,"gim"),I=>this.storeBeginCustomDirective(I)),P=i.default.replace(P,S,this.storeEndCustomDirective(S)),P=i.default.replace(P,new RegExp(`@else${p}(${y})*`,"gim"),I=>this.storeElseCustomDirective(I)),P}),s.test(a)&&(a=this.preserveCustomDirective(a)),a}preserveInlineDirective(e){let t=new RegExp(`(<[\\w\\-\\_]+?[^>]*?)${k}(${le.join("|")})(\\s*?)?(\\([^)]*?\\))?((?:(?!@end\\2).)+)(@end\\2|@endif)(.*?/*>)`,"gims"),n=i.default.replace(e,t,(r,s,a,l,o,c,d,p)=>l===void 0&&o===void 0?`${s}${this.storeInlineDirective(`${k}${a.trim()}${c.trim()} ${d.trim()}`)}${p}`:l===void 0?`${s}${this.storeInlineDirective(`${k}${a.trim()}${o.trim()}${c}${d.trim()}`)}${p}`:o===void 0?`${s}${this.storeInlineDirective(`${k}${a.trim()}${l}${c.trim()} ${d.trim()}`)}${p}`:`${s}${this.storeInlineDirective(`${k}${a.trim()}${l}${o.trim()} ${c.trim()} ${d.trim()}`)}${p}`);return t.test(n)?this.preserveInlineDirective(n):n}async preserveInlinePhpDirective(e){return i.default.replace(e,new RegExp(`(?!\\/\\*.*?\\*\\/)(${O.join("|")})(\\s*?)${y}`,"gmsi"),t=>this.storeInlinePhpDirective(t))}preserveBladeDirectivesInScripts(e){return i.default.replace(e,/(?<=<script[^>]*?(?<!=)>)(.*?)(?=<\/script>)/gis,t=>{let n=[...$,...O];if(new RegExp(n.join("|"),"gmi").test(t)===!1)return/^[\s\n]+$/.test(t)?t.trim():t;let r=O.join("|"),s=new RegExp(`(?!\\/\\*.*?\\*\\/)(${r})(\\s*?)${y}`,"gmi"),a=i.default.chain(E).without("@endphp"),l=t;return l=i.default.replace(l,s,o=>this.storeBladeDirective(C(o,{...this.defaultPhpFormatOption,printWidth:F}))),l=i.default.replace(l,new RegExp(`(${$.join("|")})\\s*?${y}`,"gis"),o=>`if ( /*${this.storeBladeDirectiveInScript(o)}*/ ) {`),l=i.default.replace(l,new RegExp(`(${[...D,...ee].join("|")})(?!\\w+?\\s*?\\(.*?\\))`,"gis"),o=>`/***script_placeholder***/} /* ${this.storeBladeDirectiveInScript(o)} */ {`),l=i.default.replace(l,new RegExp(`(${a.join("|")})`,"gis"),o=>`/***script_placeholder***/} /*${this.storeBladeDirectiveInScript(o)}*/`),l=i.default.replace(l,/(?<!@)@php(.*?)@endphp/gis,(o,c)=>this.storeRawBlock(c)),l=this.preserveCustomDirectiveInScript(l),l})}preserveBladeDirectivesInStyles(e){return i.default.replace(e,/(?<=<style[^>]*?(?<!=)>)(.*?)(?=<\/style>)/gis,t=>{let n=t,r=new RegExp(`(?!${["@end","@else",...M].join("|")})@(\\w+)\\s*?(?![^\\1]*@end\\1)${y}`,"gmi");n=i.default.replace(n,r,c=>`${this.storeBladeDirectiveInStyle(c)} {/* inline_directive */}`);let s=new RegExp(`(?!${["@end","@else",...M].join("|")})@(\\w+)\\s*?(${y})`,"gmi");n=i.default.replace(n,s,c=>`${this.storeBladeDirectiveInStyle(c)} { /*start*/`);let a=new RegExp(`(${$.join("|")})\\s*?(${y})`,"gmi");n=i.default.replace(n,a,c=>`${this.storeBladeDirectiveInStyle(c)} { /*start*/`);let l=new RegExp(`(${["@else\\w+",...D].join("|")})\\s*?(${y})?`,"gmi");n=i.default.replace(n,l,c=>`} ${this.storeBladeDirectiveInStyle(c)} { /*else*/`);let o=new RegExp(`${["@end\\w+",...E].join("|")}`,"gmi");return n=i.default.replace(n,o,c=>`} /* ${this.storeBladeDirectiveInStyle(c)} */`),n})}preserveCustomDirectiveInScript(e){let t=[...i.default.without($,"@unless"),...E,...D,"@unless\\(.*?\\)"].join("|"),n=[...i.default.without($,"@unless"),...E,...D,...O,...T,"@unless[a-z]*\\(.*?\\)",...U].join("|"),r=new RegExp(`(?!(${n}))(@([a-zA-Z1-9_\\-]+))(?!.*?@end\\3)${y}.*?(?<!@end\\5)`,"gis"),s=new RegExp(`(?!(${t}))(@(unless)*([a-zA-Z1-9_\\-]+))(?!.*?\\2)(\\s|\\(.*?\\))+(.*?)(@end\\4)`,"gis"),a;return a=i.default.replace(e,r,l=>this.storeInlineCustomDirective(l)),a=i.default.replace(a,s,(l,o,c,d,p,u,m,S)=>{if($.includes(c))return l;let P=l;return P=i.default.replace(P,new RegExp(`${c}(${y})*`,"gim"),I=>`if ( /*${this.storeBladeDirectiveInScript(I)}*/ ) {`),P=i.default.replace(P,new RegExp(`@else${p}(${y})*`,"gim"),I=>`/***script_placeholder***/} /* ${this.storeBladeDirectiveInScript(I)} */ {`),P=i.default.replace(P,S,I=>`/***script_placeholder***/} /*${this.storeBladeDirectiveInScript(I)}*/`),P}),s.test(a)&&(a=this.preserveCustomDirectiveInScript(a)),a}breakLineBeforeAndAfterDirective(e){e=i.default.replace(e,new RegExp(`(?<=<.*?(?<!=)>)(${i.default.without($,"@php").join("|")})(\\s*)${y}.*?(?=<.*?>)`,"gmis"),s=>`
${s.trim()}
`),e=i.default.replace(e,new RegExp(`(?<=<.*?(?<!=)>).*?(${i.default.without(E,"@endphp").join("|")})(?=<.*?>)`,"gmis"),s=>`
${s.trim()}
`);let t=["@case",...D];e=i.default.replace(e,new RegExp(`(\\s*?)(${t.join("|")})(\\s*?)${y}(\\s*)`,"gmi"),s=>`
${s.trim()}
...
`),(n=s.errors[0].params)!=null&&n.allowedValues&&console.log((r=s.errors[0].params)==null?void 0:r.allowedValues),g.default.exit(1)}}}async processPaths(){await Promise.all(v.default.map(this.paths,async e=>this.processPath(e)))}async processPath(e){await N.globFiles(e).then(t=>v.default.map(t,n=>B.default.relative(".",n))).then(t=>this.filterFiles(t)).then(this.fulFillFiles).then(t=>this.formatFiles(t))}static globFiles(e){return new Promise((t,n)=>{(0,We.default)(e,(r,s)=>r?n(r):t(s))})}async filterFiles(e){if(this.ignoreFile==="")return e;let t=/^\.\.*/,n=v.default.filter(e,a=>t.test(B.default.relative(".",a))),r=v.default.xor(e,n),s=(0,je.default)().add(this.ignoreFile).filter(r);return v.default.concat(n,s)}static fulFillFiles(e){return this.targetFiles.push(e),Promise.resolve(e)}async formatFiles(e){await Promise.all(v.default.map(e,async t=>this.formatFile(t)))}async formatFile(e){await this.findTailwindConfig(e),await this.readRuntimeConfig(e),await G(e).then(t=>Promise.resolve(t.toString("utf-8"))).then(t=>new A(this.options).formatContent(t)).then(t=>this.checkFormatted(e,t)).then(t=>this.writeToFile(e,t)).catch(t=>{this.handleError(e,t)})}async checkFormatted(e,t){this.printFormattedOutput(e,t);let n=j.default.readFileSync(e,"utf-8"),r=z(n),s=z(t),a=_e(e,r,s);return this.diffs.push(a),this.outputs.push(t),a.length>0&&((this.options.progress||this.options.write)&&g.default.stdout.write(b.default.green("F")),this.options.checkFormatted&&(g.default.stdout.write(`${e}
`),g.default.exitCode=1),this.formattedFiles.push(e)),a.length===0&&(this.options.progress||this.options.write)&&g.default.stdout.write(b.default.green(".")),Promise.resolve(t)}printFormattedOutput(e,t){this.options.write||this.options.checkFormatted||(g.default.stdout.write(`${t}`),v.default.last(this.paths)===e||v.default.last(this.targetFiles)===e)||(this.paths.length>1||this.targetFiles.length>1)&&g.default.stdout.write(`
`)}writeToFile(e,t){this.options.write&&(this.options.checkFormatted||t.length===0||v.default.isNull(t)||v.default.isEmpty(t)||j.default.writeFile(e,t,n=>{n&&(g.default.stdout.write(`${b.default.red(n.message)}
...
Formatted Files: 
`)),v.default.each(this.formattedFiles,e=>g.default.stdout.write(`${b.default.bold(e)}
`))}printDifferences(){if(this.options.diff){if(g.default.stdout.write(b.default.bold(`
Differences: 

`)),v.default.filter(this.diffs,e=>e.length>0).length===0){g.default.stdout.write((0,b.default)(`No changes found. 

`));return}v.default.each(this.diffs,e=>ye(e))}}printErrors(){v.default.isEmpty(this.errors)||(g.default.stdout.write(b.default.red.bold(`
Errors: 

`)),v.default.each(this.errors,e=>g.default.stdout.write(`${se.default.format(e)}
